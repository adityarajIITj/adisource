...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden bg-surface-primary">
      ...
      <Link
        href="/"
        className="absolute top-6 left-6 z-20 flex items-center gap-2 text-sm font-medium text-text-secondary hover:text-accent transition-colors"
      >
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="card-elevated border border-border rounded-3xl p-10 text-center login-card-enter bg-white">
          {/* Logo */}
          ...
          <h1 className="text-2xl font-extrabold tracking-tight mb-2">
            Welcome to <span className="accent-underline">adisource</span>
          </h1>
          ...
          <button
            ...
            disabled={signingIn}
            className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-2xl font-bold text-sm transition-all duration-300 bg-white border border-border hover:border-accent hover:shadow-md text-text-primary disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none"
          >
            {signingIn ? (
          ...
          <div className="mt-8">
            ...
            <button
              ...
              className="w-full py-4 rounded-2xl font-bold text-sm transition-all duration-300 bg-surface-secondary border border-border text-text-secondary hover:bg-white hover:border-accent hover:text-accent flex items-center justify-center gap-2"
            >
          ...
          {/* Auth error */}
          {authError && (
            <div className="mt-4 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/20 text-red-500 text-xs text-left leading-relaxed font-medium">
              {authError}
            </div>
          )}

          {/* Footer note */}
          <p className="mt-6 text-xs text-text-muted leading-relaxed font-medium">
